...
const Footer = () => {
    return (
        <div className="flex mt-4 items-center border-y-[1px] h-12 p-4 bg-white">
            ...
            <DiReact color='rgb(156 163 175)' strokeWidth='.1px' size='1.75rem'/>
            <p className="font-extralight text-sm text-gray-400 ml-1">Powered by React.js</p>

            //Project programmer
            <p className="ml-auto mr-auto md:mr-0 text-sm text-gray-400 font-extralight">©{new Date().getFullYear()} Toprak Ekin Yüksel</p>
        </div>
    );
}
